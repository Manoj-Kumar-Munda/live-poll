  ...
  return (
    <div className="grid min-h-svh bg-stage lg:grid-cols-2">
      <section className="flex flex-col px-6 py-8 sm:px-10 lg:px-16">
        <Link
          href="/"
          className="mb-10 inline-flex w-fit items-center gap-2 text-sm text-text-secondary hover:text-black hover:underline"
        >
          Back to home
        </Link>
      ...
      <aside className="relative hidden overflow-hidden bg-electric px-10 py-12 lg:flex lg:flex-col lg:justify-center">
        <div
          className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,rgba(255,255,255,0.18),transparent_46%)]"
          aria-hidden="true"
        />
